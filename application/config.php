...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '2&l@gHfErhq/I-Y+C3a)B:.?"!Sz=]v$u0Wc18p{', //默认数据加密KEY
	'data_cache_key'=> '2&l@gHfErhq/I-Y+C3a)B:.?"!Sz=]v$u0Wc18p{',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'2&l@gHfErhq/I-Y+C3a)B:.?"!Sz=]v$u0Wc18p{', //加密KEY
