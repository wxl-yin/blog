...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '[=~kbIHr{qU1]_Y:|MGawh$)>%0fS7/2!8JBV4&s', //默认数据加密KEY
	'data_cache_key'=> '[=~kbIHr{qU1]_Y:|MGawh$)>%0fS7/2!8JBV4&s',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'[=~kbIHr{qU1]_Y:|MGawh$)>%0fS7/2!8JBV4&s', //加密KEY
